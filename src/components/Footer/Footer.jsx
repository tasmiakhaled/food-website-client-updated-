            ...
            <hr className="t_border my-4 ml-0 text-left" />
              ...
              <Row>
                <Col lg="12" className="form-group">
                  <button className="btn ac_btn btnMain" type="submit"> 
                  Send
                  </button>
                </Col>
              </Row>
        ...
        <Row className="mt-5">
          ...
          <Col lg="6" md="6">
            <div className="social__links d-flex align-items-center gap-4 justify-content-end">
              ...
              <span>
                {" "}
                <Link to="https://www.facebook.com/tasmia.khaled?mibextid=ZbWKwL">
                  <i class="ri-facebook-line"></i>
                </Link>{" "}
              </span>

              <span>
                <Link to="https://github.com/tasmiakhaled">
              ...
              <span>
                {" "}
                <Link to="https://www.linkedin.com/in/tasmia-khaled-b43173211/">
